...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM ds.cpl_corporate_phone_lines WHERE cpl_phone_number = '+503-7000-0001') THEN
    INSERT INTO ds.cpl_corporate_phone_lines(cpl_phone_number, cpl_contract_start_date, cou_id, cpl_actual_cost_rate, cpl_created_by)
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM ds.cpl_corporate_phone_lines WHERE cpl_phone_number = '+503-7000-0002') THEN
    INSERT INTO ds.cpl_corporate_phone_lines(cpl_phone_number, cpl_contract_start_date, cpl_contract_end_date, cou_id, cpl_actual_cost_rate, cpl_created_by)
...
DO $$ BEGIN
  ...
  AND NOT EXISTS (
    ...
    INSERT INTO ds.cpa_corporate_phone_assignments(cpl_id, tms_id, cpa_bill_rate, cpa_assign_date_start, cpa_billable, cpa_created_by)
    VALUES (
