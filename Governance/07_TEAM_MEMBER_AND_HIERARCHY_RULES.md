...
Hierarchy traversal belongs to the canonical team member service.

## Canonical Function Ownership
Use the hierarchy logic owned in:

`src/services/teamMember/`

The canonical hierarchy traversal function is:
