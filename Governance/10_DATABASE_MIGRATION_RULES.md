...
The database team owns all DDL execution. Claude must never include or suggest the following commands in any plan or code:
- `prisma migrate dev`
...
If a task requires adding a table, column, index, constraint, or any other DDL change, the correct process is:
