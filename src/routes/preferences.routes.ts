...
function validatePreferences(
  ...
  // Validate "quickAccessHintDismissed" key if present
  if ('quickAccessHintDismissed' in raw) {
    if (typeof raw.quickAccessHintDismissed !== 'boolean') {
      return { valid: false, error: '"quickAccessHintDismissed" must be a boolean' };
    }
    result.quickAccessHintDismissed = raw.quickAccessHintDismissed;
  }
