      ...
      const assign = await insertPhoneAssignment(
        {
          ...
          cellphonePrice:  dto.cellphonePrice ?? 0,
  ...
  async update(
    ...
    const needsAssignmentRotation =
      ...
      ((dto.teamMemberId !== undefined && dto.teamMemberId !== activeAssignment.teamMemberId) ||
        ...
        (dto.cellphonePrice !== undefined &&
          Number(dto.cellphonePrice) !== Number(activeAssignment.cellphonePrice)) ||
      ...
      newAssign = await insertPhoneAssignment(
        {
          ...
          cellphonePrice:  dto.cellphonePrice   ?? Number(activeAssignment.cellphonePrice),
          ...
          const newAssignment = await insertPhoneAssignment(
            {
              ...
              cellphonePrice:  Number(oldAssignment.cellphonePrice),
