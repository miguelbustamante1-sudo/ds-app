...
export function PayrolManagementPage() {
  ...
  const columns: ColumnDef<PayrolDTO>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <Badge variant={row.original.prlStatus === 'Open' ? 'default' : 'secondary'}>
      ...
      <Card>
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            <CardTitle>Payrol Management</CardTitle>
            <Button
              size="sm"
              onClick={() => {
          ...
          <DataGridContainer>
            <DataGrid table={table} recordCount={payrols.length} isLoading={isLoading}>
              <DataGridTable />
              <DataGridPagination />
            </DataGrid>
          </DataGridContainer>
