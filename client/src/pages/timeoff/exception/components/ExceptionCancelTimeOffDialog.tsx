...
interface ExceptionCancelTimeOffDialogProps {
  open: boolean;
...
export function ExceptionCancelTimeOffDialog({
  open,
  onOpenChange,
  timeOff,
  onConfirm,
        ...
        <div className="space-y-4 py-4">
          <div className="bg-muted rounded-lg p-4 space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{formatUTCDate(timeOff.timeOffStartDate)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-muted-foreground">End Date:</span>
              <span className="font-medium">{formatUTCDate(timeOff.timeOffEndDate)}</span>
            </div>
            <div className="flex justify-between text-sm">
