...
interface CancelMyTimeOffDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  timeOff: TimeOffWithDetailsDTO | null;
  /** The other leg of this split, if `timeOff` is a split leg. */
...
export function CancelMyTimeOffDialog({
  open,
  onOpenChange,
  timeOff,
  sibling,
