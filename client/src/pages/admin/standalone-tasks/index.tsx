...
import { ImportFlagsDialog } from './ImportFlagsDialog';
...
export function StandaloneTasksAdminPage() {
  ...
  const [importFlagsOpen, setImportFlagsOpen] = useState(false);
  ...
  return (
    <div className="container">
      <Toolbar>
        ...
        <ToolbarActions>
          {canCreate('StandaloneTaskAdmin') && (
            <>
              <Button variant="outline" onClick={() => setImportFlagsOpen(true)}>
                Import Flags
              </Button>
      ...
      <ImportFlagsDialog
        open={importFlagsOpen}
        onOpenChange={setImportFlagsOpen}
        onImported={() => void loadTasks()}
      />
    </div>
  );
}
