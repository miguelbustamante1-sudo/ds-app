...
export function TaskInputPanel({ wflId, task, onRefresh, canEdit }: TaskInputPanelProps) {
  ...
  const handleView = (input: WtiWorkflowTemplateTaskInput) => {
    setEditingInput(input);
    setSheetMode('view');
    setDrawerOpen(true);
  };
    ...
    <div>
      ...
      <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
        <SheetContent className="w-[500px] sm:max-w-[500px] overflow-y-auto">
          <SheetHeader>
            <SheetTitle>
              {sheetMode === 'view' ? 'Input Details' : editingInput ? 'Edit Input' : 'Add Input'}
            </SheetTitle>
          </SheetHeader>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="inp-order" type="number" disabled={sheetMode === 'view'} {...register('displayOrder')} />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Textarea id="inp-desc" disabled={sheetMode === 'view'} {...register('description')} rows={2} />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input id="inp-default" disabled={sheetMode === 'view'} {...register('defaultValue')} />
            </div>

            <div className="space-y-1.5">
              <Label htmlFor="inp-validation">Validation Rule</Label>
              <Input id="inp-validation" disabled={sheetMode === 'view'} {...register('validationRule')} />
            </div>
