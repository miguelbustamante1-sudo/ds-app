...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  { heading: 'Maintenance' },
  {
    ...
    icon: Database,
    children: [
      { title: 'Countries', path: '/maintenance/countries', icon: Globe },
      { title: 'Holidays', path: '/maintenance/holidays', icon: Gift },
      { title: 'Projects', path: '/maintenance/projects', icon: FolderKanban },
      { title: 'Supervisor Assignments', path: '/maintenance/supervisor-assignments', icon: UserCheck },
      { title: 'Team Members', path: '/maintenance/team-members', icon: Users },
      { title: 'Users', path: '/maintenance/users', icon: UserCircle },
    ],
  },
];
