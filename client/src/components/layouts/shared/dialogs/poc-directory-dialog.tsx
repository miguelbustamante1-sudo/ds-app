...
const POC_DATA: PocEntry[] = [
  ...
  { task: 'Compensatory Hours', sv: 'Pablo', gt: 'Pablo', mx: 'Pablo', category: 'Compensatory Hours', description: 'Any questions regarding the usage or the spendature of compensatory hours.', dashboard: [{ label: 'TM Dashboard', url: 'https://datastudio.google.com/reporting/924ad5ec-3aad-4afe-a1ab-d020b198d6d4/page/p_ysix92letd' }] },
  ...
  { task: 'CSR Payroll Donations TICA', sv: 'Pablo', gt: 'Pablo', mx: 'Pablo', category: 'CSR', description: 'Information regarding all donors information' },
  ...
  { task: 'Invoice Compilation File', sv: 'Pablo', gt: 'Pablo', mx: 'Pablo', category: 'Invoices', description: 'Centralize the data of the generated invoices in a single file' },
  ...
  { task: 'Laptops Audits', sv: 'Pablo', gt: 'Nova', mx: 'N/A', category: 'Assets', description: 'Inventory review' },
  ...
  { task: 'Onboardings', sv: 'Pablo', gt: 'Nova, Gaby', mx: 'Nova', category: 'People', description: 'Any questions regarding onboarding at any step, including Fieldglass approvals and creation' },
  ...
  { task: 'Payroll', sv: 'Pablo', gt: 'Gaby', mx: 'Nova', category: 'Payroll', description: 'Document that is shared to register the payments (Bonos, Reimbursements, On Call, English Bonus) that must be processed in each payroll event' },
  ...
  { task: 'TDS Distros Check Report', sv: 'Pablo', gt: 'Pablo', mx: 'Pablo', category: 'Communication', description: 'Information regarding distros and communication channels' },
  ...
  { task: 'Training and Certifications File', sv: 'Pablo', gt: 'Nova', mx: 'Nova', category: 'L&D', description: 'Information regarding the process of certifications validation', relatedForms: [{ label: 'Inform Form', url: 'https://docs.google.com/forms/d/e/1FAIpQLSdFBgotS3ZZcxt47E25KJJBN-ZJKtQKgOx4kWjMco-UdVl5Mg/viewform' }] },
  { task: 'Training Purchase & Budget Admin', sv: 'Pablo', gt: 'Nova', mx: 'N/A', category: 'L&D', description: 'Promissory Notes, Training Approvals, Budget Q&A' },
  { task: 'Udemy', sv: 'Pablo', gt: 'Pablo', mx: 'Pablo', category: 'L&D', description: 'Any information related to your Udemy hours and how they are being counted towards tech hours' },
...
const CATEGORY_COLORS: Record<string, string> = {
  Communication:       'bg-uds-system-blue-100 text-uds-system-blue-700',
  Compliance:          'bg-uds-system-red-100 text-uds-system-red-700',
  'Compensatory Hours':'bg-uds-system-amber-200 text-uds-system-amber-600',
  'Corporate Lines':   'bg-uds-system-grey-100 text-uds-system-grey-600',
  CSAT:                'bg-uds-telus-purple-100 text-uds-telus-purple-500',
  CSR:                 'bg-uds-system-green-100 text-uds-system-green-700',
  People:              'bg-uds-system-blue-100 text-uds-system-blue-700',
  Assets:              'bg-uds-system-amber-100 text-uds-system-amber-600',
  Giftcards:           'bg-uds-system-red-100 text-uds-system-red-600',
  Invoices:            'bg-uds-telus-purple-100 text-uds-telus-purple-400',
  Parking:             'bg-uds-system-blue-100 text-uds-system-blue-500',
  Payroll:             'bg-uds-system-green-200 text-uds-system-green-700',
  SAP:                 'bg-uds-system-grey-100 text-uds-system-grey-600',
  'L&D':               'bg-uds-telus-purple-100 text-uds-telus-purple-400',
  'DS App':            'bg-uds-system-blue-100 text-uds-system-blue-600',
};
