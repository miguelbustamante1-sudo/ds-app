...
import { TimeOffHubSummaryCards } from "@/pages/time-off-hub/components/TimeOffHubSummaryCards";
...
// ---------------------------------------------------------------------------
function HubSummarySection({ hubKey }: { hubKey: string }) {
  if (hubKey === 'time-off') {
    return <TimeOffHubSummaryCards />;
  }
  return null;
}
...
export function HubPage({ config, className }: HubPageProps) {
  ...
  return (
    <div className={cn("container", className)}>
      ...
      <HubSummarySection hubKey={config.key} />
